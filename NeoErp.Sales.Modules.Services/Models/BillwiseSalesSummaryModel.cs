...
{
  public  class BillwiseSalesSummaryModel
  {
    ...
    public class BillwiseSalesSummaryViewModel
    {
        public BillwiseSalesSummaryViewModel()
        {
            BillwiseSalesSummary = new List<BillwiseSalesSummaryModel>();
            AggregationResult = new Dictionary<string, AggregationModel>();
        }

        public List<BillwiseSalesSummaryModel> BillwiseSalesSummary { get; set; }
