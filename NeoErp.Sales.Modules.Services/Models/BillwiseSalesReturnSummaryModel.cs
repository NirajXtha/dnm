...
{
   public class BillwiseSalesReturnSummaryModel
   {
    ...
    public class BillwiseSalesReturnSummaryViewModel
    {
        public BillwiseSalesReturnSummaryViewModel()
        {
            BillwiseSalesReturnSummary = new List<BillwiseSalesReturnSummaryModel>();
            AggregationResult = new Dictionary<string, AggregationModel>();
        }

        public List<BillwiseSalesReturnSummaryModel> BillwiseSalesReturnSummary { get; set; }
