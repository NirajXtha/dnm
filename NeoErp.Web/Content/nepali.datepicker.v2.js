...
// Get 2 digit Number
	...
	function NepaliDateConverter(){
		...
		this.bs[2060] = new Array(30, 32, 31, 32, 31, 30, 29, 30, 29, 29, 30, 30);
		this.bs[2061] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2062] = new Array(31, 31, 31, 32, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2063] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2064] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2065] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2066] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2067] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2068] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2069] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2070] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2071] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2072] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2073] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2074] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2075] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2076] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2077] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2078] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2079] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2080] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2081] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2082] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2083] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
		this.bs[2084] = new Array(31, 31, 32, 31, 31, 30, 29, 30, 30, 29, 30, 30);
		this.bs[2085] = new Array(31, 31, 31, 32, 31, 29, 30, 30, 30, 29, 30, 30);
