...
QMModule.config(function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.when('/QuotationApproval', {
        templateUrl: '/QuotationManagement/Home/QuotationApproval',
    });
    $routeProvider.when('/QuotationLogs', {
        templateUrl: '/QuotationManagement/Home/QuotationLogs',
    });
    $routeProvider.when('/ValueAssign', {
        templateUrl: '/QuotationManagement/Home/ValueAssign',
    });
    $routeProvider.when('/UserPermission', {
        templateUrl: '/QuotationManagement/Home/UserPermission',
    });
