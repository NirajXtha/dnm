...
QCQAModule.controller('allMaterialCtrl', function ($scope, $rootScope, $http, $routeParams, $window, $filter) {
    $scope.childRowIndex;
    ...
    var getProductsByUrl = window.location.protocol + "//" + window.location.host + "/api/DailyWastageAPI/GetMaterialGroupLists";
    ...
    //show modal popup
    $scope.BrowseTreeListForAllMaterials = function (index) {
