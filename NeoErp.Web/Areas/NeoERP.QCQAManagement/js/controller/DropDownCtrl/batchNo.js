////QCQAModule.controller('batchCtrl', function ($scope, $rootScope, $http, $routeParams, $window, $filter) {
////    $scope.childRowIndex;
...
////                type: "json",
////                transport: {
////                    read: "/api/RawMaterialAPI/GetBatchNoByItemCode?itemCode=" + itemCode,
////                    /*read: "/api/RawMaterialAPI/GetBatchNoByItemCode?itemCode=" + itemCode + '&itemMastercode=' + itemMasterCode + '&searchText=' + searchText,*/
////                },
////                schema: {
////                    type: "json",
////                    model: {
...
////                    var combo = $("#batch_" + $scope.childRowIndex).data('kendoComboBox');
////                    if (combo == null) {
...
////                    }
////                    $("#batch_" + $scope.childRowIndex).data('kendoComboBox').dataSource.data([{ ItemCode: productcode, ItemDescription: productName, Type: "code" }]);
...
////                    }
////                    $('#batchModal_' + $scope.childRowIndex).modal('toggle');
...
////    //show modal popup
////    $scope.BrowseTreeListForBatch = function (index) {
////        $('#batchModal_' + index).modal('show');
...
////        //$("#productGrid_" + $scope.childRowIndex).html("");
////        /*BindProductGrid(currentItem.itemCode, currentItem.masterItemCode, "");*/
////        BindProductGrid(138, currentItem.masterItemCode, "");
////        $scope.$apply();
////        //$scope.options = {
////        //    loadOnDemand: false,
////        //    select: function (e) {
...
////        //    },
////        //};
////        if ($('#batchtree_' + $scope.childRowIndex).data("kendoTreeView") != undefined)
////            $('#batchtree_' + $scope.childRowIndex).data("kendoTreeView").expand('.k-item');
////    }
////});
