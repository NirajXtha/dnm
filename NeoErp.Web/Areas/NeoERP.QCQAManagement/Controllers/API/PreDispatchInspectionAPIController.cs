...
{
    public class PreDispatchInspectionAPIController : ApiController
    {
        // GET: PreDispatchInspectionAPI
        private const string QCQA = "Pre Dispatch Inspection";
        private IPreDispatchInspectionRepo _preDispatchInspectionRepoRepo;
        ...
        public PreDispatchInspectionAPIController(IPreDispatchInspectionRepo _IPreDispatchInspectionRepo, IDbContext dbContext, IWorkContext workContext, ICacheManager cacheManager, NeoErpCoreEntity objectEntity)
        {
            this._preDispatchInspectionRepoRepo = _IPreDispatchInspectionRepo;
        ...
        {
            List<Items> tableLists = _preDispatchInspectionRepoRepo.GetInvoiceNoList();
        ...
        {
            PreDispatchInspection tableLists = _preDispatchInspectionRepoRepo.GetDispatchDetails(InvoiceNo);
            //var dataList = new Items();
            return tableLists;
        }
        [HttpGet]
        ...
        {
            List<PreDispatchInspection> tableLists = _preDispatchInspectionRepoRepo.GetPreDispatchInspectionCheckList();
            //var dataList = new Items();
            return tableLists;
        }
        [HttpGet]
        public List<PreDispatchInspection> GetPreDispatchInspectionByIdCheckList(string predispatch)
        {
            List<PreDispatchInspection> tableLists = _preDispatchInspectionRepoRepo.GetPreDispatchInspectionCheckList();
            //var dataList = new Items();
            return tableLists;
        }
        public IHttpActionResult savePreDispatchInspection(PreDispatchInspection predispatchInspection)
        {
            try
            {
                bool isPosted = _preDispatchInspectionRepoRepo.InsertPreDispatchInspectionData(predispatchInspection);
                if (isPosted)
                {
        ...
        {
            PreDispatchInspection qc = _preDispatchInspectionRepoRepo.GetEditPreDispatchInspection(transactionno);
            return qc;
        }
        [HttpGet]
        public PreDispatchInspection GetPreDispatchInspectionReport(string transactionno)
        {
            ...
            var SalesOrderDetailFormDetailByFormCodeAndOrderNo = this._preDispatchInspectionRepoRepo.GetPreDispatchInspectionReport(transactionno);
