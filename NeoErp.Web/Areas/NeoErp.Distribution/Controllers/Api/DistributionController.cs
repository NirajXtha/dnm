...
namespace NeoErp.Distribution.Controllers.Api
{
    public class DistributionController : ApiController
    {
        ...
        [HttpPost]
        public MRVisitedTrackingList GetMrVistitedPlan(string spCode)
        {
            ...
            data.VisitActivityList = _distributionService.GetCurrentMrVistedRoute(spCode, comp);
            return data;
        ...
        [HttpPost]
        public dynamic UpdateCollectionPdc(dynamic data)
        {
            return this._distributionService.UpdateCollectionPdc(data, _workContext.CurrentUserinformation);
        }
