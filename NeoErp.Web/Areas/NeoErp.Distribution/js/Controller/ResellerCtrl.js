...
distributionModule.controller('ResellerCtrl', function ($scope, $http, ResellerService, $routeParams) {
    ...
    $scope.grid = {
        dataSource: {
            ...
            transport: {
                ...
                parameterMap: function (options, type) {
                    console.log("Filter Applied:", $scope.dateFilterApplied);
                    var extraParams = $scope.dateFilterApplied
                        ? ReportFilter.filterAdditionalData()
                        : {};
                    var paramMap = JSON.stringify($.extend(options, extraParams));
                ...
                parse: function (data) {
                    ...
                    if (data.inActive > 0) {
                        Metronic.alert({
                            ...
                            message: data.inActive + " new outlets are waiting for activation.",
        ...
        columns: [
            ...
            {
                field: "CREATED_DATE_STR",
                title: "Created Date",
                width: "9%",
                template: function (dataItem) {
                    console.log(kendo.toString(new Date(dataItem.created_date), "dd-MMM-yyyy"));
    ...
    $scope.initialize = async function () {
        ...
        marker = L.marker(myLatlng, { draggable: true, title: "center" }).addTo(map);
    ...
    function ExportToExcel(e) {
        ...
        SheetRow.push({
            cells: [
                ...
                { value: "Created Date", background: "#A9A7A6", },
                ...
                if (typeof (row.items) != "undefined") {
                    ...
                    SheetRow.push({
                        cells: [{
                            ...
                            value: row.created_date ? kendo.toString(new Date(row.created_date), "dd-MMM-yyyy") : "N/A",
                        },
                        {
