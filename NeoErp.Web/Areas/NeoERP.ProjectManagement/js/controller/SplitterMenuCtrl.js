PMModule.controller('SplitterMenuCtrl', function ($scope, $http, $routeParams, $window, $filter) {
    $scope.subMenuList = [];
    ...
    function BindGrid(formCode, tableName) {
        ...
        $scope.doSomething = function (orderNo) {
            ...
            if ($scope.moduleCode == "01")
                ...
                window.location.href = "/ProjectManagement/Home/ConsumptionEntry?formcode=" + formCode + "&vNo=" + voucherno + ""
