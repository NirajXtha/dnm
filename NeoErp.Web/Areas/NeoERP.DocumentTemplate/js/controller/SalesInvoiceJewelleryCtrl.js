...
DTModule.controller('SalesInvoiceJewelleryCtrl', function ($scope, $rootScope, $http, $routeParams, salesInvoiceJewelleryService, $window, $filter, hotkeys) {
    ...
    $scope.checkRefrences = function () {
        var req = "/api/TemplateApi/GetRefrenceFlagSalesInvoiceJewellery";
    ...
    $scope.refrenceFn = function (response, callback) {
        ...
        if (rows.length > 0) {
            ...
            //var grandtotalsaleOrder = salesInvoiceJewelleryService.getGrandTotalSalesOrder_ByFormCodeAndOrderNo_Ref(reforderno,deffered);
            ...
            if ($scope.DocumentName !== 'SA_SALES_CHALAN') {
                ...
                if ($rootScope.IncludeCharge === "True") {
                    ...
                    var chargeUrlForEdit = "/api/TemplateApi/GetChargeDataForEditSalesInvoiceJewellery";
    ...
    var formDetail = salesInvoiceJewelleryService.getFormDetail_ByFormCode(d1);
    $.when(d1).done(function (result) {
        ...
        if ($scope.OrderNo == undefined || $scope.OrderNo == "undefined") {
            //var newordernumber = "";
            var formCodeNew = "496";
            var newordernumber = salesInvoiceJewelleryService.getnewlygeneratedvoucherno($scope.companycode, formCodeNew, $scope.todaydate, $scope.DocumentName, d6);
/*            var newordernumber = salesInvoiceJewelleryService.getnewlygeneratedvouchernoNew($scope.todaydate, d6);*/
    ...
    if (typeof $scope.OrderNo != "undefined") {
       ...
       // var grandtotalsaleOrder = salesInvoiceJewelleryService.getGrandTotalSalesOrder_ByFormCodeAndOrderNo($scope.OrderNo, $scope.FormCode, d5);
        var grandtotalsaleOrder = "";
    ...
    //var formSetup = salesInvoiceJewelleryService.getFormSetup_ByFormCode($scope.FormCode, d2);
    var formSetup = "";
    ...
    //var formCustomSetup = salesInvoiceJewelleryService.getFormCustomSetup_ByFormCode($scope.FormCode, $scope.OrderNo, d3)
    var formCustomSetup = ""
    ...
    $scope.getDraftDetails = function () {
        ...
        //var formDetail = salesInvoiceJewelleryService.getDraftFormDetail_ByFormCode(templateCode, d7);
        var formDetail = "";
    ...
    $scope.saveTemplateInDraft = function () {
        ...
        return response.then(function (data) {
            ...
            var formCodeNew = "496";
            var req = "/api/TemplateApi/GetNewOrderNo?companycode=" + $scope.companycode + "&formcode=" + formCodeNew + "&currentdate=" + $scope.todaydate + "&tablename=" + $scope.DocumentName + '&isSequence=false';
            $http.get(req).then(function (results) {
    ...
    $scope.SaveDocumentFormData = function (param) {
        ...
        if ($scope.masterModels.hasOwnProperty("SALES_DATE")) {
            var master_SALES_DATE = $scope.masterModels.SALES_DATE;
            if (master_SALES_DATE == null || master_SALES_DATE == "" || master_SALES_DATE == undefined) {
                displayPopupNotification("Date/Miti is required", "warning");
                return $scope.loadingBtnReset();
            }
            //else {
            //    $(".mlocation").removeClass("borderRed");
    ...
    //    var date = new Date();
    //    $scope.todaydate = $filter('date')(new Date(), 'dd-MMM-yyyy');
    //    var newordernumber = salesInvoiceJewelleryService.getnewlygeneratedvoucherno($scope.companycode, $scope.FormCode, $scope.todaydate, $scope.DocumentName, newdeffered);
    ...
    $scope.ResetDocument = function () {
        ...
        if ($scope.OrderNo === "undefined") {
            ...
            debugger;
            var formCodeNew = "496";
            var newordernumber = salesInvoiceJewelleryService.getnewlygeneratedvoucherno($scope.companycode, formCodeNew, $scope.todaydate, $scope.DocumentName, newdeffered);
            //var newordernumber = salesInvoiceJewelleryService.getnewlygeneratedvouchernoNew($scope.todaydate, newdeffered);
            ...
            debugger;
            //var saleOrderformDetail = salesInvoiceJewelleryService.getSalesOrderDetail_ByFormCodeAndOrderNo($scope.FormCode, $scope.OrderNo, d4);
            var saleOrderformDetail = "";
    ...
    $scope.masterModelDataFn = function (fn) {
        ...
        $.when(d4).done(function (result) {
            ...
            if ($scope.tempCode != undefined) {
                ...
                //if (one === 1) {
                //    salesInvoiceJewelleryService.getDraftData_ByFormCodeAndTempCode(formcode, tempCode).then(function (result) {
...
/*        $("#nepaliDate5").val(a);*/
    ...
    //if ($scope.OrderNo === "undefined") {
    var chargeUrl = "/api/TemplateApi/GetChargeDataSalesInvoiceJewellery";
