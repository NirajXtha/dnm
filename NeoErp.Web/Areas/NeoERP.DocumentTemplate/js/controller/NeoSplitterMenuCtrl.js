DTModule.controller('SplitterMenuCtrl', function ($scope, $http, $routeParams, $window, $filter) {
    ...
    function BindGrid(formCode, tableName) {
        ...
        $scope.printdata = function (formcode, orderNo) {
            ...
            $.when(d1, d3).done(function () {
                ...
                console.log("/api/TemplateApi/GetSalesOrderDetailFormDetailByFormCodeAndOrderNo?formCode=" + formcode + "&orderno=" + orderNo)
                $http.get(reqst).then(function (responsesod) {
                   

                    console.log(responsesod.data);
            ...
            function setDataOnModal(rows, i) {
                ...
                console.log($scope.masterModelTemplate);
                ...
                $scope.masterModels["ARRIVAL_DATE"] = rows[0].ARRIVAL_DATE;
                $scope.masterModels["DEPARTURE_DATE"] = rows[0].DEPARTURE_DATE;
                $scope.masterModels["ROOMNUMBER"] = rows[0].ROOMNUMBER;
            }
