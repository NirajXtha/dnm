...
DTModule.controller('ContraVoucherCtrl', function ($scope, $rootScope, $http, $routeParams, contravoucherservice, formtemplateservice, contravoucherfactory, $window, $filter, hotkeys) {
    ...
    $scope.dynamicModalData = [{
        ACC_CODE: "",
        BUDGET_FLAG: "",
        BUDGET_MODAL_OPENED: false,
        IS_BUDGET_MODAL_CORRECT: false,
        BUDGET: [{
            SERIAL_NO: 1,
            BUDGET_CODE: "",
            AMOUNT: "",
    ...
    $scope.dynamicSubLedgerModalData = [{
        ...
        SUBLEDGER_AMOUNT: "",
        REMAINING_AMOUNT: "",
        SUBLEDGER_MODAL_OPENED: false, // Flag to track if modal has been opened
        IS_SUBLEDGER_MODAL_CORRECT: false,
        SUBLEDGER: [{
            SERIAL_NO: 1,
            SUB_CODE: "",
            SUB_EDESC: "",
    ...
    $scope.dynamicTDSModalData = [{
        ...
        TOTAL_TDS_AMOUNT: "",
        SUPPLIER_CODE: "",
        TDS_MODAL_OPENED: false, // Flag to track if modal has been opened
        USE_CR_TDS_MODAL: false, // Flag to track if user chose CR modal for DR transaction
        IS_TDS_MODAL_CORRECT: false,
        CHILDTDS: [{
            SERIAL_NO: 1,
            SUPPLIER_CODE: "",
            ACC_CODE: "",
    ...
    $scope.dynamicVATModalData = [{
        ...
        VEHICLE_PUR_FLAG: "",
        EXEMPTED_FLAG: "",
        VAT_MODAL_OPENED: false, // Flag to track if modal has been opened
        IS_VAT_MODAL_CORRECT: false,
        CHILDVAT: [{
            SERIAL_NO: 1,
            SUPPLIER_CODE: "",
            CUSTOMER_CODE: "",
    ...
    $scope.refrencefinanceFn = function (response, callback) {
        ...
        //$scope.TDS_CHILD_MODAL.push({ SERIAL_NO: "", SUPPLIER_CODE: "", ACC_CODE: "", TDS_TYPE_CODE: "", MEETING_CODE: "", NET_AMOUNT: "", TDS_PERCENTAGE: "", TDS_AMOUNT: "" });
                    ...
                    for (var b = 0; b < $scope.dynamicSubLedgerModalData.length; b++) {
                        ...
                        for (var a = 0; a < res.data.length; a++) {
                            ...
                            if (res.data[a].ACC_CODE == $scope.dynamicSubLedgerModalData[b].ACC_CODE && res.data[a].TRANSACTION_TYPE == $scope.dynamicSubLedgerModalData[b].TRANSACTION_TYPE) {
                                ...
                                // Set flag to indicate modal has data
                                $scope.dynamicSubLedgerModalData[b].SUBLEDGER_MODAL_OPENED = true;
                                iii = iii + 1;
                            }
                        }
                    }
                    $scope.dynamicSubLedgerModalData[rowsObj].SUBLEDGER_MODAL_OPENED = true;
                }
    ...
    $scope.add_child_element = function (e) {
        ...
        $scope.dynamicSubLedgerModalData.push({
            ...
            SUBLEDGER_AMOUNT: "",
            REMAINING_AMOUNT: "",
            _MODAL_OPENED: false, // Flag to track if modal has been opened
            SUBLEDGER: [{
                SERIAL_NO: serialno,
                SUB_CODE: "",
                SUB_EDESC: "",
    ...
    $.when(d1).done(function (result) {
        ...
        var tempFn = function (result) {
            ...
            $scope.SUBLEDGER_MODAL.push({ ACC_CODE: "", TRANSACTION_TYPE: "", VOUCHER_AMOUNT: "", SUBLEDGER_AMOUNT: "", REMAINING_AMOUNT: "", SUBLEDGER_MODAL_OPENED: false, SUBLEDGER: [] });
            $scope.SUBLEDGER_CHILD_MODAL.push({ SERIAL_NO: "", SUB_CODE: "", SUB_EDESC: "", PARTY_TYPE_CODE: "", AMOUNT: "", PARTICULARS: "", REFRENCE: "" });

            $scope.TDS_MODAL.push({ ACC_CODE: "", VOUCHER_NO: "", INVOICE_DATE: "", REMARKS: "", TOTAL_TDS_AMOUNT: "", CHILDTDS: [] });
            $scope.TDS_CHILD_MODAL.push({ SERIAL_NO: "", INVOICE_DATE: "", SUPPLIER_CODE: "", ACC_CODE: "", TDS_TYPE_CODE: "", MEETING_CODE: "", NET_AMOUNT: "", TDS_PERCENTAGE: "", TDS_AMOUNT: "", VOUCHER_NO: "", SUBMISSION_NO: "", REMARKS: "" });
            $scope.VAT_MODAL.push({ ACC_CODE: "", INVOICE_NO: "", INVOICE_DATE: "", REMARKS: "", REFRENCE_NO: "", DOC_TYPE: "", TYPE: "", TOTAL_VAT_AMOUNT: "", EXEMPTED_FLAG: "", VEHICLE_PUR_FLAG: "", PURCHASE_QUANTITY: "", PP_NO: "", PURCHASE_ITEM: "", PURCHASE_UNIT: "", CHILDVAT: [] });
            $scope.VAT_CHILD_MODAL.push({ SERIAL_NO: "", SUPPLIER_CODE: "", CUSTOMER_CODE: "", TAXABLE_AMOUNT: "", VAT_AMOUNT: "" });
            ...
            function setDataOnModal(rows, i) {
                ...
                response.then(function (res) {
                    ...
                    if (res.data != "" && res.data.length > 0) {
                        ...
                        for (var b = i; b < $scope.dynamicSubLedgerModalData.length; b++) {
                            var voucherAmt = 0;
                            var snoo = b + 1;
                            ...
                            for (var a = 0; a < res.data.length; a++) {
                                ...
                                if (res.data[a].ACC_CODE == $scope.dynamicSubLedgerModalData[b].ACC_CODE && res.data[a].TRANSACTION_TYPE == $scope.dynamicSubLedgerModalData[b].TRANSACTION_TYPE) {
                                    ...
                                    $scope.dynamicSubLedgerModalData[b].SUBLEDGER_MODAL_OPENED = true;
                                    $scope.dynamicSubLedgerModalData[b].IS_SUBLEDGER_MODAL_CORRECT = true;
                                }
                            }
                    ...
                    //else {
                    //    // No subledger data - remove the last added entry
                    //    $scope.dynamicSubLedgerModalData.pop();
                    //}
                        ...
                        for (var b = 0; b < $scope.dynamicModalData.length; b++) {
                            ...
                            for (var a = 0; a < budgetResult.data.length; a++) {
                                if (budgetResult.data[a].ACC_CODE == $scope.dynamicModalData[b].ACC_CODE && budgetResult.data[a].SERIAL_NO == bsno) {
                                    ...
                                    $scope.dynamicModalData[b].BUDGET[bi] = $scope.getObjWithKeysFromOtherObj(budgetChildModel, budgetResult.data[a]);
                                    bi = bi + 1;
                                    $scope.dynamicModalData[b].BUDGET_MODAL_OPENED = true;
                                }
                            }
                        }
                    }
                    //else {
                    //    // No budget data - remove the last added entry
                    //    $scope.dynamicModalData.pop();
                    //}
                });
                var tdsresponse = $http.get('/api/ContraVoucherApi/GetDataForTDSModal?VOUCHER_NO=' + rows[i].VOUCHER_NO + '&accCode=' + rows[i].ACC_CODE, config);
                tdsresponse.then(function (tdsres) {
                    debugger;
                    if (tdsres.data != "" && tdsres.data.length > 0) {
                        //for (var a = 0; a < tdsres.data.length; a++) {
                        //    for (var b = 0; b < $scope.dynamicTDSModalData.length; b++) {
                        ...
                        for (var b = 0; b < $scope.dynamicTDSModalData.length; b++) {
                            ...
                            for (var a = 0; a < tdsres.data.length; a++) {
                                if (tdsres.data[a].SERIAL_NO == bsno) {
                                    // Set parent-level fields from first matching record
                                    if (bi === 0 && tdsres.data[a]) {
                                        $scope.dynamicTDSModalData[b].TDS_DATE = tdsres.data[a].INVOICE_DATE; // Also set TDS_DATE for date picker
                                    }
                                    ...
                                    $scope.dynamicTDSModalData[b].TDS_MODAL_OPENED = true;
                                }
                            }
                    ...
                    //else {
                    //    // No TDS data - remove the last added entry
                    //    $scope.dynamicTDSModalData.pop();
                    //}
                });
                var vatresponse = $http.get('/api/ContraVoucherApi/GetDataForVATModal?VOUCHER_NO=' + rows[i].VOUCHER_NO + '&accCode=' + rows[i].ACC_CODE, config);
                vatresponse.then(function (vatres) {
                    debugger;
                    if (vatres.data != "" && vatres.data.length > 0) {
                        //for (var a = 0; a < vatres.data.length; a++) {
                        //    for (var b = 0; b < $scope.dynamicVATModalData.length; b++) {
                        ...
                        //    }
                        //}
                        for (var b = i; b < $scope.dynamicVATModalData.length; b++) {
                            var bsno = b + 1;
                            ...
                            if ($scope.dynamicVATModalData[b] == undefined) {
                                $scope.dynamicVATModalData[b] = [];
                            }

                            // Temporary array to store CHILDVAT data
                            var tempChildVAT = [];

                            for (var a = 0; a < vatres.data.length; a++) {
                                if (vatres.data[a].ACC_CODE == $scope.dynamicVATModalData[b].ACC_CODE && vatres.data[a].SERIAL_NO == bsno) {
                                    // Store CHILDVAT data in temporary array
                                    tempChildVAT.push($scope.getObjWithKeysFromOtherObj(subvatchildModel, vatres.data[a]));

                                    // Update parent object properties (DOC_TYPE, TYPE, etc.)
                                    $scope.dynamicVATModalData[b] = $scope.getObjWithKeysFromOtherObj(vatModel, vatres.data[a]);

                                    // Convert string flags to boolean for checkbox binding
                                    // AngularJS checkboxes with ng-model require boolean values
                                    $scope.dynamicVATModalData[b].VEHICLE_PUR_FLAG = (vatres.data[a].VEHICLE_PUR_FLAG === "Y");
                                    $scope.dynamicVATModalData[b].EXEMPTED_FLAG = (vatres.data[a].EXEMPTED_FLAG === "Y");

                                    bi = bi + 1;

                                    $scope.dynamicVATModalData[b].VAT_MODAL_OPENED = true;
                                    $scope.dynamicVATModalData[b].IS_VAT_MODAL_CORRECT = true;
                                }
                            }

                            // Restore CHILDVAT array after parent object update
                            if (tempChildVAT.length > 0) {
                                $scope.dynamicVATModalData[b].CHILDVAT = tempChildVAT;
                            }
                            /*$scope.dynamicVATModalData[i].VAT_MODAL_OPENED = true;*/
                        }
                    }
                    //else {
                    //    // No VAT data - remove the last added entry
                    //    $scope.dynamicVATModalData.pop();
                    //}
                    // Initialize and select values for VAT dropdowns
                    // Wait for Angular ng-if to render the partial views
                    setTimeout(function () {
                        for (var b = 0; b < $scope.dynamicVATModalData.length; b++) {
                            var row = $scope.dynamicVATModalData[b];
                            if (!row.CHILDVAT) continue;

                            for (var c = 0; c < row.CHILDVAT.length; c++) {
                                var child = row.CHILDVAT[c];

                                if (row.DOC_TYPE === 'S' && child.CUSTOMER_CODE) {
                                    (function (rowIndex, childIndex, customerCode) {
                                        // Use attribute selector to find the specific dropdown
                                        var dropdownSelector = 'input[vat-key="' + rowIndex + '"][vat-index="' + childIndex + '"]';

                                        // Fetch customer details from server
                                        $http.get('/api/TemplateApi/GetAllCustomerSetupByFilter?filter=' + customerCode)
                                            .then(function (response) {
                                                if (response.data && response.data.length > 0) {
                                                    var dropdown = $(dropdownSelector).data('kendoComboBox');
                                                    if (dropdown) {
                                                        // Set the data source with the fetched result
                                                        dropdown.dataSource.data(response.data);
                                                        // Set the value
                                                        dropdown.value(customerCode);
                                                    }
                                                }
                                            });
                                    })(b, c, child.CUSTOMER_CODE);
                                }
                                else if (row.DOC_TYPE === 'P') {
                                    // Existing logic for Supplier
                                    var dropdownSelector = 'input[vat-key="' + b + '"][vat-index="' + c + '"]';
                                    if (child.SUPPLIER_CODE && $(dropdownSelector).length > 0) {
                                        var dropdown = $(dropdownSelector).data('kendoComboBox');
                                        if (dropdown) {
                                            dropdown.value(child.SUPPLIER_CODE);
                                        }
                                    }
                                }
                            }
                        }
                    }, 1000); // 1 second delay to ensure DOM is fully ready

                });


                $scope.getAllDropdownValues = function () {
                    debugger;
                    var allValues = [];
                    ...
                    for (var b = 0; b < $scope.dynamicVATModalData.length; b++) {
                        ...
                        if (!row.CHILDVAT) continue; // skip rows with no dropdowns
                        ...
                        for (var c = 0; c < row.CHILDVAT.length; c++) {
                            ...
                            allValues.push({
                                rowIndex: b,
                                childIndex: c,
                                docType: row.DOC_TYPE,           // 'P' or 'S'
                                value: child.CUSTOMER_CODE || child.SUPPLIER_CODE,  // depending on type
                                text: child.CUSTOMER_NAME || child.SUPPLIER_NAME    // optional
                            });
                        }
                    }
    ...
    // Function to reset modal data when a child row is deleted
    $scope.resetChildModalData = function (index) {
        // Reset SubLedger modal data
        if ($scope.dynamicSubLedgerModalData[index]) {
        ...
        // Reset TDS modal data
        if ($scope.dynamicTDSModalData[index]) {
            $scope.dynamicTDSModalData[index] = {
                ACC_CODE: 0,
                VOUCHER_NO: "",
                SUBMISSION_NO: "",
                INVOICE_DATE: "",
        ...
        // Reset VAT modal data
        if ($scope.dynamicVATModalData[index]) {
            $scope.dynamicVATModalData[index] = {
                ACC_CODE: 0,
                INVOICE_NO: "",
                INVOICE_DATE: "",
                REMARKS: "",
        ...
        // Reset Budget modal data (if it exists)
        if ($scope.dynamicModalData && $scope.dynamicModalData[index]) {
            $scope.dynamicModalData[index] = {
                ACC_CODE: "",
                BUDGET_FLAG: "",
                BUDGET_MODAL_OPENED: false,
                BUDGET: [{
    ...
    $scope.add_childbudgetflag_element = function (e) {
        ...
        // Check if the first row has a Budget Center selected
        if ($scope.dynamicModalData[index].BUDGET && $scope.dynamicModalData[index].BUDGET.length > 0) {
            var firstRowBudgetCode = $scope.dynamicModalData[index].BUDGET[0].BUDGET_CODE;

            if (!firstRowBudgetCode || firstRowBudgetCode === "") {
                displayPopupNotification("Please select Budget Center for the first row before adding more rows", "warning");
                e.preventDefault();
                e.stopPropagation();
                return false;
            }
        ...
        $scope.dynamicModalData[index].BUDGET.push({
            SERIAL_NO: $scope.dynamicModalData[index].BUDGET.length + 1,
            BUDGET_CODE: "",
            AMOUNT: "",
            NARRATION: ""
        });
    ...
    $scope.BudgetChange = function (index, BUDGET_AMOUNT) {
        debugger;
        // Get the outside amount from childModels
        var outsideAmount = 0;
        if ($scope.childModels[index] && $scope.childModels[index].AMOUNT) {
            outsideAmount = parseFloat($scope.childModels[index].AMOUNT);
        }

        var sum = 0;
        var budgetLength = $scope.dynamicModalData[index].BUDGET.length;

        // Calculate sum of all budget amounts
        ...
        // Validate that sum doesn't exceed outside amount
        if (outsideAmount > 0 && sum > outsideAmount) {
            $scope.LedgerAmountValidation = "Budget amount cannot exceed the outside amount of " + outsideAmount.toFixed(2);
        ...
        // Auto-manage rows based on amount distribution
        if (outsideAmount > 0) {
            var remainingAmount = outsideAmount - sum;

            // If there's remaining amount and we're on the last row with a value
            if (remainingAmount > 0 && budgetLength > 0) {
                var lastRowWithAmount = -1;
                for (var i = budgetLength - 1; i >= 0; i--) {
                    if ($scope.dynamicModalData[index].BUDGET[i].AMOUNT &&
                        $scope.dynamicModalData[index].BUDGET[i].AMOUNT > 0) {
                        lastRowWithAmount = i;
                        break;
                    }
                }
                ...
                //if (lastRowWithAmount >= 0) {
                //    // Check if there's an empty row after the last row with amount
                //    var hasEmptyRow = false;
                //    for (var i = lastRowWithAmount + 1; i < budgetLength; i++) {
                //        if (!$scope.dynamicModalData[index].BUDGET[i].AMOUNT ||
                //            $scope.dynamicModalData[index].BUDGET[i].AMOUNT === 0) {
                //            hasEmptyRow = true;
                //            // Set the remaining amount to this empty row
                //            $scope.dynamicModalData[index].BUDGET[i].AMOUNT = parseFloat(remainingAmount.toFixed(2));
                //            break;
                //        }
                //    }
            ...
            // Remove extra empty rows if sum equals outside amount
            if (remainingAmount === 0 && budgetLength > 1) {
                // Keep only rows that have amounts or budget codes
                var rowsToKeep = [];
                for (var i = 0; i < budgetLength; i++) {
                    if (($scope.dynamicModalData[index].BUDGET[i].AMOUNT &&
                        $scope.dynamicModalData[index].BUDGET[i].AMOUNT > 0) ||
                        ($scope.dynamicModalData[index].BUDGET[i].BUDGET_CODE &&
                            $scope.dynamicModalData[index].BUDGET[i].BUDGET_CODE !== "")) {
                        rowsToKeep.push($scope.dynamicModalData[index].BUDGET[i]);
                    }
                }

                // If we have rows to keep, update the array
                if (rowsToKeep.length > 0) {
                    $scope.dynamicModalData[index].BUDGET = rowsToKeep;
                    // Update serial numbers
                    for (var i = 0; i < $scope.dynamicModalData[index].BUDGET.length; i++) {
                        $scope.dynamicModalData[index].BUDGET[i].SERIAL_NO = i + 1;
                    }
                }
            }
        }
        ...
        if ($("#BudgetAmount").hasClass("borderRed") || $scope.LedgerAmountValidation !== "") {
            $($("#BudgetOk")).addClass("disabled");
        }
        else {
    ...
    $scope.calculatevatamount = function (key, index) {
        ...
        // Check if VAT is exempted
        if ($scope.dynamicVATModalData[key].EXEMPTED_FLAG === true) {
            // If VAT exempted, set VAT_AMOUNT to 0 but keep TAXABLE_AMOUNT
            $scope.dynamicVATModalData[key].CHILDVAT[index].VAT_AMOUNT = "0.00";
        } else {
            // Calculate VAT amount normally
            var vat_amount = (parseFloat(taxable_amount) / 100) * 13;

            if ($scope.dynamicVATModalData[key].VEHICLE_PUR_FLAG === true) {
                // Round to nearest whole number
                $scope.dynamicVATModalData[key].CHILDVAT[index].VAT_AMOUNT = ((parseFloat(vat_amount) / 100) * 40).toFixed(2);
                vat_amount = ((parseFloat(vat_amount) / 100) * 40).toFixed(2);
            }

            // Check if ROUNDOFF is enabled
            if ($scope.dynamicVATModalData[key].ROUNDOFF === true) {
                // Round to nearest whole number
                $scope.dynamicVATModalData[key].CHILDVAT[index].VAT_AMOUNT = Math.round(vat_amount).toFixed(2);
            } else {
    ...
    $scope.calculateBaseamount = function (key, index) {
        ...
        // Check if VAT is exempted
        if ($scope.dynamicVATModalData[key].EXEMPTED_FLAG === true) {
            // If VAT exempted, don't calculate taxable amount from VAT amount
            // Keep the existing taxable amount as is
        } else {
            // Calculate taxable amount from VAT amount normally
            ...
            // If ROUNDOFF is enabled, round the VAT amount that was entered
            if ($scope.dynamicVATModalData[key].ROUNDOFF === true) {
                var vatAmountValue = parseFloat($scope.dynamicVATModalData[key].CHILDVAT[index].VAT_AMOUNT);
                $scope.dynamicVATModalData[key].CHILDVAT[index].VAT_AMOUNT = Math.round(vatAmountValue).toFixed(2);
            }
        }
    ...
    $scope.handleVatExemptedChange = function (key) {
        debugger;
        if ($scope.dynamicVATModalData[key].CHILDVAT && $scope.dynamicVATModalData[key].CHILDVAT.length > 0) {
            if ($scope.dynamicVATModalData[key].EXEMPTED_FLAG === true) {
                for (var i = 0; i < $scope.dynamicVATModalData[key].CHILDVAT.length; i++) {
                    $scope.dynamicVATModalData[key].CHILDVAT[i].VAT_AMOUNT = 0;
                }
                $scope.dynamicVATModalData[key].TOTAL_VAT_AMOUNT = 0;

            }
            else {
                for (var i = 0; i < $scope.dynamicVATModalData[key].CHILDVAT.length; i++) {

                    var taxableAmount = (parseFloat($scope.dynamicVATModalData[key].CHILDVAT[i].TAXABLE_AMOUNT) / 100) * 13;

                    // Skip if VAT_AMOUNT is not a valid number
                    if (isNaN(taxableAmount)) {
                        continue;
                    }

                    if ($scope.dynamicVATModalData[key].VEHICLE_PUR_FLAG === true) {
                        taxableAmount = ((parseFloat(taxableAmount) / 100) * 40).toFixed(2);
                    }

                    // Apply rounding if ROUNDOFF is enabled
                    if ($scope.dynamicVATModalData[key].ROUNDOFF === true) {
                        taxableAmount = Math.round(taxableAmount).toFixed(2);
                    } else {
                        // Keep the current value with 2 decimal precision
                        taxableAmount = parseFloat(taxableAmount).toFixed(2);
                    }

                    $scope.dynamicVATModalData[key].CHILDVAT[i].VAT_AMOUNT = taxableAmount;
                }

                var totalvatsum = 0;
                $.each($scope.dynamicVATModalData[key].CHILDVAT, function (key, value) {
                    var amount = parseFloat(value.VAT_AMOUNT);
                    if (!isNaN(amount)) {
                        totalvatsum += amount;
                    }
                });
    ...
    // Handle ROUNDOFF checkbox change
    $scope.handleRoundOffChange = function (key) {
        // Check if CHILDVAT exists and has items
        debugger;
        if ($scope.dynamicVATModalData[key].EXEMPTED_FLAG !== true) {
            if ($scope.dynamicVATModalData[key].CHILDVAT && $scope.dynamicVATModalData[key].CHILDVAT.length > 0) {
                // Iterate through all CHILDVAT items
                for (var i = 0; i < $scope.dynamicVATModalData[key].CHILDVAT.length; i++) {
                    //var vatAmount = parseFloat($scope.dynamicVATModalData[key].CHILDVAT[i].VAT_AMOUNT);
    ...
    // Handle Vehicle Purchase checkbox change
    $scope.handleVehiclePurchasefChange = function (key) {
        debugger;
    ...
    $scope.handleEnableDirectEntryChaange = function (key) {
        debugger;
        var isDocTypeLocked = false;
        var isTypeLocked = false;

        if ($scope.dynamicVATModalData[key].Enable_DirectEntry === true) {
            isDocTypeLocked = true;
            isTypeLocked = true;
        }
        $scope.dynamicVATModalData[key].isTypeLocked = isTypeLocked;
        $scope.dynamicVATModalData[key].isDocTypeLocked = isDocTypeLocked;
    }
    ...
    $scope.TDS_Ok = function (index, e) {
        ...
        for (var i = 0; i < tdschildLength; i++) {
            ...
            var child_tdsamount = $scope.dynamicTDSModalData[index].TOTAL_TDS_AMOUNT;
            if (child_tdsamount === null || child_tdsamount === "" || child_tdsamount === 0) {
                displayPopupNotification("TDS  Amount Should Not Be Empty.", "warning");
                e.preventDefault();
                e.stopPropagation();
                return false;
            }
            var totaltdsamount = $scope.dynamicTDSModalData[index].TOTAL_TDS_AMOUNT;
            if (totaltdsamount === null || totaltdsamount === "" || totaltdsamount === 0) {
                displayPopupNotification("Total TDS  Amount Should Not Be Empty.", "warning");
                e.preventDefault();
                e.stopPropagation();
                return false;
            }
        ...
        $scope.dynamicTDSModalData[index].TDS_MODAL_OPENED = true;
        $scope.dynamicTDSModalData[index].IS_TDS_MODAL_CORRECT = true;
        var sum = 0;
        $.each($scope.childModels, function (key, value) {
    ...
    $scope.VAT_Ok = function (index, e) {
        ...
        for (var i = 0; i < vatchildLength; i++) {
            ...
            var child_customercode = $scope.dynamicVATModalData[index].CHILDVAT[i].CUSTOMER_CODE;
            ...
            if ($scope.dynamicVATModalData[index].Enable_DirectEntry == false) {
                if ($scope.dynamicVATModalData[index].DOC_TYPE === "P") {
                    if (child_suppliercode === null || child_suppliercode === "") {
                        displayPopupNotification("Supplier Code Should Not Be Empty.", "warning");
                        e.preventDefault();
                        e.stopPropagation();
                ...
                else if ($scope.dynamicVATModalData[index].DOC_TYPE === "S") {
                    if (child_customercode === null || child_customercode === "") {
                        displayPopupNotification("Customer Code Should Not Be Empty.", "warning");
                        e.preventDefault();
                        e.stopPropagation();
                        return false;
                    }
        ...
        // Set flag to indicate modal has been opened and data saved
        $scope.dynamicVATModalData[index].VAT_MODAL_OPENED = true;
        $scope.dynamicVATModalData[index].IS_VAT_MODAL_CORRECT = true;
        var sum = 0;
        $.each($scope.childModels, function (key, value) {
    ...
    $scope.vat_Cancel = function (e) {
        ...
        //$scope.dynamicVATModalData[e].PURCHASE_QUANTITY = "";
        //$scope.dynamicVATModalData[e].PP_NO = "";
        //$scope.dynamicVATModalData[e].PURCHASE_ITEM = "";
        //$scope.dynamicVATModalData[e].PURCHASE_UNIT = "";
    ...
    $scope.Budget_Ok = function (e) {
        ...
        $scope.dynamicModalData[index].BUDGET_MODAL_OPENED = true;
        $scope.dynamicModalData[index].IS_BUDGET_MODAL_CORRECT = true;
        var csum = 0;
        angular.forEach($scope.childModels, function (value, key) {
    ...
    $scope.remove_child_element = function (index) {
        ...
        if ($scope.ChildFormElement.length > 1) {
            ...
            $scope.dynamicTDSModalData.splice(index, 1);
            $scope.dynamicVATModalData.splice(index, 1);
        ...
        $.each($scope.dynamicTDSModalData, function (key, value) {
            $.each(value.CHILDTDS, function (key, values) {
                values.SERIAL_NO = tdsserialno;

            });
            tdsserialno++;
        })

        $.each($scope.dynamicVATModalData, function (key, value) {
            $.each(value.CHILDVAT, function (key, values) {
                values.SERIAL_NO = vatserialno;
            ...
            if (e.sender.dataItem()) {
                ...
                response.then(function (res) {
                    ...
                    if (res.data != "0") {
                        ...
                        $scope.currentTdsIndex = index;

                        // Check TRANSACTION_TYPE to decide whether to show confirmation or open directly
                        var transactionType = $scope.childModels[index].TRANSACTION_TYPE;

                        if (transactionType === "DR") {
                            // Debit - Show confirmation modal
                            $("#tdsConfirmationModal").modal('show');
                        } else if (transactionType === "CR") {
                            // Credit - Open TDS popup directly
                            popupAccessTds = true;
                ...
                response.then(function (res) {
                    ...
                    if (res.data != "0") {
                        ...
                        // Set flag to show the budget icon (regardless of AMOUNT)
                        $scope.dynamicModalData[index].BUDGET_MODAL_OPENED = true;

                        // Check if AMOUNT exists before opening budget modal
                        var hasAmount = $scope.childModels[index] && $scope.childModels[index].AMOUNT && $scope.childModels[index].AMOUNT > 0;

                        if (hasAmount) {
                            // Only open modal if amount is provided
                            if ($scope.popUpBudget) {
                                $scope.popUpBudget(index);
                            }
                        } else {
                            // Don't open modal, but icon is visible due to BUDGET_MODAL_OPENED flag
                            console.log('Budget Center icon visible. AMOUNT is required to open modal');
                        }
    ...
    // Simple budget center data source - NO LOOPS!
    $scope.budgetCenterDataSource = {
        ...
        transport: {
            ...
            parameterMap: function (data, action) {
                var newParams;
                if (data.filter != undefined && data.filter.filters[0] != undefined) {
                    newParams = {
                        filter: data.filter.filters[0].value,
    ...
    $scope.VATCustomerCodeAutocomplete =
    {
        dataSource: $scope.VATCustomerDataSource,
        suggest: false,
        highlightFirst: true,
        select: function (e) {

            var description = e.dataItem.CUSTOMER_CODE;
            var Code = e.dataItem.CUSTOMER_CODE;
            var key = this.element[0].attributes['vat-key'].value;

            if (this.element[0].attributes['vat-index'] !== undefined) {
                var index = this.element[0].attributes['vat-index'].value;
                $scope.dynamicVATModalData[key].CHILDVAT[index].CUSTOMER_CODE = description;


                var sublen = $scope.dynamicVATModalData[key].CHILDVAT.length;
                //check valildation after select new code  start
                for (var j = 0; j < sublen; j++) {
                    var subcode = $scope.dynamicVATModalData[key].CHILDVAT[j].CUSTOMER_CODE;
                    if (index != j) {
                        if (subcode === Code) {
                            $scope.VATCodeValidation = "You cannot select same Code.";
                            //$($(".SUBLEDGERCODE_" + index)[1]).addClass("borderRed");
                            $($(".vatcustomerDESCRIPTION_" + index)[1]).addClass("borderRed");
                            $scope.vatcount = true;
                            return;
                            ...
                            //$($(".SUBLEDGERCODE_" + index)[1]).removeClass("borderRed");
                            $($(".vatcustomerDESCRIPTION_" + index)[1]).addClass("borderRed");
                            if (!$(".vatcustomersecond").hasClass("borderRed")) {
                                $scope.VATCodeValidation = '';
                            }
        ...
        dataBound: function (e) {
            ...
            if (this.element[0].attributes['vat-index'] !== undefined) {
                var index = this.element[0].attributes['vat-index'].value;
                var vatcustomerLength = ((parseInt(index) + 1) * 3) - 1;
                var vatcustomer = $($(".vatcustomersecond")[vatcustomerLength]).data("kendoComboBox");
                if (vatcustomer != undefined) {
                    vatcustomer.setOptions({
                        template: $.proxy(kendo.template("#= formatValue(CustomerName,Type,this.text()) #"), vatcustomer)
                    });
                }
            }
    ...
    $scope.popUp = function ($index) {
        ...
        if (popupAccess === true) {
            ...
            $scope.dynamicSubLedgerModalData[$index].SUBLEDGER_MODAL_OPENED = true;
        }
    ...
    $scope.popUpTds = function ($index) {
        ...
        if (popupAccessTds === true) {
            ...
            // Set TDS Payment Entry checkbox to checked for DR transactions
            if ($scope.childModels[$index].TRANSACTION_TYPE === 'DR') {
                $scope.dynamicTDSModalData[$index].TDS_PAYMENT_ENTRY = true;
            }

            // Set voucher number from master form
            $scope.dynamicTDSModalData[$index].VOUCHER_NO = $scope.masterModels.VOUCHER_NO;

            //var totaltaxableamount = 0;
            //angular.forEach($scope.dynamicTDSModalData[$index].CHILDTDS, function (value, key) {

            //    totaltaxableamount = value.TDS_AMOUNT;
            //});
            ...
            $(".dynamictdsModal_" + $index).on('shown.bs.modal', function () {
                ...
                setTimeout(function () {
                    ...
                    if (!$scope.dynamicTDSModalData[$index].TDS_DATE) {
                        $scope.dynamicTDSModalData[$index].TDS_DATE = new Date();
                    }


                    var initialDate = $scope.dynamicTDSModalData[$index].TDS_DATE;

                    // Initialize English datepicker (jQuery UI)
                    $('#tdsDateEnglish_' + $index).datepicker({
                        dateFormat: 'dd-M-yy',
                        changeMonth: true,
                        changeYear: true,
                        ...
                        onSelect: function (dateText, inst) {
                            ...
                            // Update model
                            $scope.dynamicTDSModalData[$index].TDS_DATE = selectedDate;

                            // Convert to Nepali and update
                            var formattedDate = moment(selectedDate).format('YYYY-MM-DD');
                            var nepDate = AD2BS(formattedDate);
                            if (nepDate) {
                                $('#tdsDateNepali_' + $index).val(nepDate);
                            }
                    ...
                    // Set initial English date
                    $('#tdsDateEnglish_' + $index).datepicker('setDate', initialDate);


                    // Convert to Nepali and set
                    var nepDateStr = AD2BS(moment(initialDate).format('YYYY-MM-DD'));

                    // Initialize Nepali date picker
                    $('#tdsDateNepali_' + $index).nepaliDatePicker({
                        dateFormat: 'YYYY-MM-DD',
                        closeOnDateSelect: true,
                        onChange: function () {
                            var nepDate = $('#tdsDateNepali_' + $index).val();
                            if (nepDate) {
                                // Convert Nepali to English
                                var engDateConverted = BS2AD(nepDate);
                                if (engDateConverted) {
                                    var engDateObj = new Date(engDateConverted);

                                    // Update jQuery datepicker
                                    $('#tdsDateEnglish_' + $index).datepicker('setDate', engDateObj);

                                    // Update model
                                    $scope.dynamicTDSModalData[$index].TDS_DATE = engDateObj;
                                    if (!$scope.$$phase) {
                                        $scope.$apply();
                                    }
                                }
                    ...
                    // Set the Nepali date value
                    if (nepDateStr) {
                        $('#tdsDateNepali_' + $index).val(nepDateStr);
                    }
    ...
    // Calculate total TDS amount from all child rows
    $scope.calculateTotalTDS = function ($index) {
        var total = 0;
        if ($scope.dynamicTDSModalData[$index] && $scope.dynamicTDSModalData[$index].CHILDTDS) {
            angular.forEach($scope.dynamicTDSModalData[$index].CHILDTDS, function (child) {
                if (child.TDS_AMOUNT) {
                    total += parseFloat(child.TDS_AMOUNT) || 0;
                }
            });
        }
        $scope.dynamicTDSModalData[$index].TOTAL_TDS_AMOUNT = total;
    }
    ...
    $scope.SaveDocumentFormData = function (param) {
        ...
        // Modal validation - Check if modals are opened but not correctly saved
        // Check Subledger Modal
        if ($scope.dynamicSubLedgerModalData && Array.isArray($scope.dynamicSubLedgerModalData)) {
            for (var i = 0; i < $scope.dynamicSubLedgerModalData.length; i++) {
                if ($scope.dynamicSubLedgerModalData[i].SUBLEDGER_MODAL_OPENED === true &&
                    $scope.dynamicSubLedgerModalData[i].IS_SUBLEDGER_MODAL_CORRECT === false) {
                    displayPopupNotification("Subledger modal exists but is not saved. Please save the modal data before proceeding.", "warning");
                    return $scope.loadingBtnReset();
                }
            }
        }
        ...
        // Check VAT Modal
        if ($scope.dynamicVATModalData && Array.isArray($scope.dynamicVATModalData)) {
            for (var i = 0; i < $scope.dynamicVATModalData.length; i++) {
                if ($scope.dynamicVATModalData[i].VAT_MODAL_OPENED === true &&
                    $scope.dynamicVATModalData[i].IS_VAT_MODAL_CORRECT === false) {
                    displayPopupNotification("VAT modal exists but is not saved. Please save the modal data before proceeding.", "warning");
                    return $scope.loadingBtnReset();
                }
            }
        }
        ...
        // Check TDS Modal
        if ($scope.dynamicTDSModalData && Array.isArray($scope.dynamicTDSModalData)) {
            for (var i = 0; i < $scope.dynamicTDSModalData.length; i++) {
                if ($scope.dynamicTDSModalData[i].TDS_MODAL_OPENED === true &&
                    $scope.dynamicTDSModalData[i].IS_TDS_MODAL_CORRECT === false) {
                    displayPopupNotification("TDS modal exists but is not saved. Please save the modal data before proceeding.", "warning");
                    return $scope.loadingBtnReset();
                }
            }
        }

        // Check Budget Center Modal
        if ($scope.dynamicModalData && Array.isArray($scope.dynamicModalData)) {
            for (var i = 0; i < $scope.dynamicModalData.length; i++) {
                if ($scope.dynamicModalData[i].BUDGET_MODAL_OPENED === true &&
                    $scope.dynamicModalData[i].IS_BUDGET_MODAL_CORRECT === false) {
                    displayPopupNotification("Budget Center modal exists but is not saved. Please save the modal data before proceeding.", "warning");
                    return $scope.loadingBtnReset();
                }
            }
        }
        ...
        //check if dr amount and cr amount is 0.00

        if ($scope.accsummary.drTotal == 0 && $scope.accsummary.crTotal == 0) {
            displayPopupNotification("Dr Amount & Cr Amount cannot be 0.00", "warning");
            return $scope.loadingBtnReset();
        }
        ...
        var SubLedgerModaldata = $.grep($scope.dynamicSubLedgerModalData, function (e) {
            // Only include if ACC_CODE has a meaningful value AND the SUBLEDGER array has actual data
            var hasValidAccCode = e.ACC_CODE && e.ACC_CODE !== 0 && e.ACC_CODE !== "" && e.ACC_CODE !== "0";
            var hasValidSubledgerData = false;

            // Check if SUBLEDGER array exists and has entries with actual SUB_CODE values
            if (e.SUBLEDGER && Array.isArray(e.SUBLEDGER) && e.SUBLEDGER.length > 0) {
                hasValidSubledgerData = e.SUBLEDGER.some(function (sub) {
                    return sub.SUB_CODE && sub.SUB_CODE !== "" && sub.SUB_CODE !== "0" && sub.SUB_CODE !== 0;
                });
            }

            return hasValidAccCode && hasValidSubledgerData;
        });
        ...
        var budgettransactiondata = $.grep($scope.dynamicModalData, function (e) {
            ...
            var hasValidAccCode = e.ACC_CODE && e.ACC_CODE !== 0 && e.ACC_CODE !== "" && e.ACC_CODE !== "0";
            var hasValidBudgetData = false;
            // Only check if ACC_CODE has a meaningful value (not default 0 or empty string)
            if (e.BUDGET && Array.isArray(e.BUDGET) && e.BUDGET.length > 0) {
                hasValidBudgetData = e.BUDGET.some(function (bud) {
                    return bud.AMOUNT && bud.AMOUNT !== "" && bud.AMOUNT !== "0" && bud.AMOUNT !== 0;
                });
            }

            return hasValidAccCode && hasValidBudgetData;
        });
        ...
        var TDSModaldata = $.grep($scope.dynamicTDSModalData, function (e) {
            ...
            var hasValidAccCode = e.ACC_CODE && e.ACC_CODE !== 0 && e.ACC_CODE !== "" && e.ACC_CODE !== "0";
            var hasValidTDSData = false;
            // Only check if ACC_CODE has a meaningful value (not default 0 or empty string)
            if (e.CHILDTDS && Array.isArray(e.CHILDTDS) && e.CHILDTDS.length > 0 && e.TOTAL_TDS_AMOUNT) {
                hasValidTDSData = e.CHILDTDS.some(function (tds) {
                    return tds.ACC_CODE && tds.ACC_CODE !== "";
                });
            }

            return hasValidAccCode && hasValidTDSData;
        });
        ...
        var VATModaldata = $.grep($scope.dynamicVATModalData, function (e) {
            debugger;
            // Only check if ACC_CODE has a meaningful value (not default 0 or empty string)
            return e.IS_VAT_MODAL_CORRECT === true;
        });
        ...
        return response.then(function (data) {
            ...
            if (data.data.MESSAGE == "INSERTED") {
                ...
                $scope.showSimplePopup(generateMsg);
                $scope.reset();
            ...
            //}
                ...
                //---Nila Changes Previous Print Modal Popup changed after implementing Print Template by Avinash dai Starts-------///
                //$("#saveAndPrintModal").modal("toggle");

                //---Nila Changes Previous Print Modal Popup changed after implementing Print Template by Avinash dai Ends-------///

                //---Nila Changes Current Print Modal Popup changed after implementing Print Template by Avinash dai Starts-------///
                ...
                //---Nila Changes Current Print Modal Popup changed after implementing Print Template by Avinash dai Ends-------///
                ...
                ////-------------Previous Print Code Commented Starts------////////////
                //var masterArr = $scope.ChildFormElement[0].element;
                //var print_master = $.grep(masterArr, function (e) {
                //    return (e['COLUMN_NAME'].indexOf("CALC") === -1 && e['COLUMN_NAME'].indexOf("REMARKS") === -1);
                //});
                ...
                ////-------------Previous Print Code Commented Ends------////////////
    ...
    $scope.ChangeDocTypeVat = function (index) {
        ...
        else if (selectedDocType === "P") {
            type = "LOC";
        }
        $scope.dynamicVATModalData[index].TYPE = type;
        $scope.dynamicVATModalData[index].isTypeLocked = isTypeLocked;
    ...
    $scope.ShowSubledgerDetail = function (index) {
        ...
        // Set flag to indicate modal has been opened
        $scope.dynamicSubLedgerModalData[index].SUBLEDGER_MODAL_OPENED = true;
        popupAccess = true;
        $scope.popUp(index);
    }
    $scope.ShowBudgetTranDetail = function (index) {
        ...
        if (!hasAmount) {
            displayPopupNotification("Please enter AMOUNT before opening Budget Center", "warning");
            return;
        }
        ...
        // 1. Set Reference No from VOUCHER_NO
        if ($scope.masterModels && $scope.masterModels.VOUCHER_NO) {
            $scope.dynamicModalData[index].REFERENCE_NO = $scope.masterModels.VOUCHER_NO;
        }

        // 2. Set Budget As to 'Expenses' if OrderNo is undefined
        if ($scope.OrderNo === "undefined") {
            $scope.dynamicModalData[index].BUDGET_AS = "Expenses";
        }


        // 3. Check AsPerBudget (set to true/checked)
        $scope.dynamicModalData[index].AS_PER_BUDGET = true;

        // Check if we're in edit mode (VOUCHER_NO exists and is not "undefined")
        var isEditMode = $scope.masterModels && $scope.masterModels.VOUCHER_NO && $scope.masterModels.VOUCHER_NO !== "undefined";
        var accCode = $scope.dynamicModalData[index].ACC_CODE || $scope.childModels[index].ACC_CODE;

        if (isEditMode && accCode) {
            // Fetch existing budget data from API during edit mode
            var config = {
                headers: {
            ...
            var response = $http.get('/api/ContraVoucherApi/GetDataForBudgetModal?VOUCHER_NO=' + $scope.masterModels.VOUCHER_NO + '&accCode=' + accCode, config);
            response.then(function (budgetResult) {
                if (budgetResult.data != "" && budgetResult.data.length > 0) {
                    ...
                    // The SERIAL_NO in API data represents the budget row number, not child row index
                    var bi = 0;

                    for (var a = 0; a < budgetResult.data.length; a++) {
                        // Load all budget rows that match the ACC_CODE (remove SERIAL_NO filter)
                        if (budgetResult.data[a].ACC_CODE == accCode) {
                            // Create budget child model structure
                            var budgetChildModel = {
                                SERIAL_NO: budgetResult.data[a].SERIAL_NO || (bi + 1),
                                BUDGET_CODE: "",
                                AMOUNT: "",
                                NARRATION: ""
                            };

                            $scope.dynamicModalData[index].BUDGET.push($scope.getObjWithKeysFromOtherObj(budgetChildModel, budgetResult.data[a]));
                            bi = bi + 1;
                        }
                    }

                    // Set flag to indicate modal has been opened with data
                    $scope.dynamicModalData[index].BUDGET_MODAL_OPENED = true;
                } else {
                    // No existing data, initialize with first row
                    initializeNewBudgetData(index);
                }

                // Open the modal after data is loaded
                openBudgetModal(index);
            }, function (error) {
                // Error fetching data, initialize with new data
                console.error('Error fetching budget data:', error);
                initializeNewBudgetData(index);
                openBudgetModal(index);
            });
        } else {
            // New mode - initialize with first row amount
            initializeNewBudgetData(index);
            openBudgetModal(index);
        }
    }

    // Helper function to initialize new budget data
    function initializeNewBudgetData(index) {
        // 4. Set first row amount from child row AMOUNT
        if ($scope.dynamicModalData[index].BUDGET && $scope.dynamicModalData[index].BUDGET.length > 0) {
            // Set the first row's amount to the child row's AMOUNT
            $scope.dynamicModalData[index].BUDGET[0].AMOUNT = $scope.childModels[index].AMOUNT;
        } else {
            // If BUDGET array doesn't exist or is empty, initialize it
            $scope.dynamicModalData[index].BUDGET = [{
                SERIAL_NO: 1,
                BUDGET_CODE: "",
                AMOUNT: $scope.childModels[index].AMOUNT,
                NARRATION: ""
            }];
        }
    ...
    // Helper function to open budget modal
    function openBudgetModal(index) {
        ...
        if ($scope.popUpBudget) {
            ...
            $(".budgetFlag_" + index).modal('show');
        }
    }

    // Function to remove budget row - prevents deletion of first row
    $scope.remove_childbudgetflag_element = function (key, index) {
        // Prevent deletion of first row (index 0)
        if (index === 0) {
            displayPopupNotification("Cannot delete the first Budget Center row", "warning");
            return false;
        }

        // Allow deletion of other rows
        if ($scope.dynamicModalData[key].BUDGET && $scope.dynamicModalData[key].BUDGET.length > 1) {
            $scope.dynamicModalData[key].BUDGET.splice(index, 1);
            ...
            for (var i = 0; i < $scope.dynamicModalData[key].BUDGET.length; i++) {
                $scope.dynamicModalData[key].BUDGET[i].SERIAL_NO = i + 1;
            }
        }
    }
    ...
    $scope.ShowTdsTranDetail = function (index) {
        ...
        // Get the account code for TDS check
        var accCode = $scope.dynamicTDSModalData[index].ACC_CODE;


        // Calculate TOTAL_TDS_AMOUNT from all child TDS_AMOUNT values
        var totalTdsAmount = 0;
        if ($scope.dynamicTDSModalData[index].CHILDTDS && $scope.dynamicTDSModalData[index].CHILDTDS.length > 0) {
            angular.forEach($scope.dynamicTDSModalData[index].CHILDTDS, function (child) {
                if (child.TDS_AMOUNT) {
                    totalTdsAmount += parseFloat(child.TDS_AMOUNT) || 0;
                }
            });
        }
        $scope.dynamicTDSModalData[index].TOTAL_TDS_AMOUNT = totalTdsAmount;

        // Check if TDS is required for this account
        $http.get('/api/TemplateApi/IfIsTdsByAccCode?accCode=' + accCode).then(function (res) {
            if (res.data != "0") {
                // TDS is required - show confirmation modal
                $scope.currentTdsIndex = index;
                //$("#tdsConfirmationModal").modal('show');

                var transactionType = $scope.childModels[index].TRANSACTION_TYPE;

                // Check if user previously chose CR modal for DR transaction (when editing)
                var useCrModal = $scope.dynamicTDSModalData[index].USE_CR_TDS_MODAL;

                if (transactionType === "DR") {
                    // Check if this is an edit and user previously chose CR modal
                    if (useCrModal && $scope.dynamicTDSModalData[index].TDS_MODAL_OPENED) {
                        // User previously chose CR modal, open modal directly
                        // The view will show CR fields based on USE_CR_TDS_MODAL flag
                        popupAccessTds = true;
                        $scope.popUpTds(index);
                    } else {
                        // Debit - Show confirmation modal (first time or user chose DR modal)
                        $("#tdsConfirmationModal").modal('show');
                    }
                } else if (transactionType === "CR") {
                    // Credit - Open TDS popup directly
                ...
                // TDS not required - close any open modal and don't open TDS popup
                $("#tdsConfirmationModal").modal('hide');
            }
    ...
    // Confirm TDS entry - user clicked "Yes"
    $scope.confirmTdsEntry = function () {
        $("#tdsConfirmationModal").modal('hide');
        var index = $scope.currentTdsIndex;
        popupAccessTds = true;

        // Set flag to indicate user chose DR modal (default behavior)
        $scope.dynamicTDSModalData[index].USE_CR_TDS_MODAL = false;
    ...
    // Cancel TDS entry - user clicked "No"
    $scope.cancelTdsEntry = function () {
        $("#tdsConfirmationModal").modal('hide');
        var index = $scope.currentTdsIndex;
        popupAccessTds = true;

        // Set flag to indicate user chose CR modal for DR transaction
        $scope.dynamicTDSModalData[index].USE_CR_TDS_MODAL = true;
    ...
    // Calculate TDS Amount from Net Amount and TDS Percentage
    $scope.calculatetdsamount = function (key, childIndex) {
        debugger;
        var tdsData = $scope.dynamicTDSModalData[key];
        if (tdsData && tdsData.CHILDTDS && tdsData.CHILDTDS[childIndex]) {
            var reff = tdsData.CHILDTDS[childIndex];
            var netAmount = parseFloat(reff.NET_AMOUNT) || 0;
            var tdsPercentage = parseFloat(reff.TDS_PERCENTAGE) || 0;

            // Calculate TDS Amount = (Net Amount * TDS Percentage) / 100
            // Convert back to number to avoid ngModel:numfmt error
            if (tdsPercentage) {
                reff.TDS_AMOUNT = parseFloat((netAmount * tdsPercentage / 100).toFixed(2));
            }
            else {
                reff.TDS_AMOUNT = netAmount;
            }

            // Recalculate total TDS amount
            $scope.calculateTotalTDS(key);
        }
    }

    // Calculate Total TDS Amount from all child TDS amounts
    $scope.calculateTotalTDS = function (key) {
        var tdsData = $scope.dynamicTDSModalData[key];
        if (tdsData && tdsData.CHILDTDS) {
            var totalTdsAmount = 0;
            angular.forEach(tdsData.CHILDTDS, function (child) {
                if (child.TDS_AMOUNT) {
                    totalTdsAmount += parseFloat(child.TDS_AMOUNT) || 0;
                }
            });
            tdsData.TOTAL_TDS_AMOUNT = totalTdsAmount.toFixed(2);
        }
    }
