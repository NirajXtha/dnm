...
namespace NeoERP.DocumentTemplate.Service.Interface
{
    public interface IFormTemplateRepo
    {
        ...
        //Prem Prakash Dhakal
        List<FormDetailSetup> GetFormDetailSalesInvoiceJewellerySetup(string formCode);
        List<DraftFormModel> GetDraftFormDetailSetup(string formCode);
        List<Customers> GetAllCustomerSetup(string filter);
        List<CustomerModels> GetAllMasterCustomerCodeByFilter(string filter);
        ...
        List<ItemUnit> GetItemUnit(string itemCode);
        ...
        List<PurchaseType> getPurchaseTypeListByFlter(string filter);
        ...
        List<TNC> GetAllTNCSetup(string filter);
        ...
        CustomerMasterMapModel GetCustomerMasterMap();
        FromLocationInfo GetFromLocationCode(string companycode, string formcode);

        //string GetFromLocationCode(string companycode, string formcode);
        ...
        List<Products> GetProductDataByProductCodeGrade(string productcode);
        List<CustomerDetail> GetCustomerDataByCustomerCode(string customerCode);
        decimal GetTotalPriceByVoucherNoFormCodeAndTableName(string voucherno, string formcode, string tableName);
        ...
        GlobalAgroProductsReport GetGlobalAgroProductsReport(string transactionno);
        string GetSalesInvoiceJewelleryDateTime(string salesno, string tableName);
        ...
        decimal GetGrandTotalAmountByOrderNo(string orderno, string formcode, string tablename);
        string GetItemNonVatFlagByItemCode(string itemCode);
        string GetItemWiseAttribute(string itemCode, string serialNo, string voucherNo, string tableName);
        ...
        List<BudgetCenter> GetAllMasterBudgetCenterByFilter(string filter, string accCode);
        ...
        List<MenuModels> GetAllUpdateItems();
        ...
        List<TNCModels> getAllTNC();

        List<LocationModels> getAllLocation();
        List<RegionalModels> getAllRegions();
        List<MiscellaneousSubLedgerModels> getAllMiscellaneousSubLedgers();
        List<AttributeModels> getAllAttributes();
        ...
        List<CustomerModels> GetCustomerListByCustomerCodeMaster(string customerMasterCode, string searchText);
        ...
        List<LocationModels> GetLocationListByLocationCode(string locationId, string locationCode, string searchText, string routineSearchText = "", string referenceNo = "");
        ...
        List<AccountCodeModels> getAllAccountCode(string searchText);
        ...
        List<CustomerModels> getAllCustomerMaster();
        List<DivisionModels> getAllDivision();
        string createNewChildCustomerSetupInSIJ(CustomerModels model);
        ...
        string GetCustomerPanNoByCustomerCode(string customerCode);
        ...
        CompanyAndBranchModel GetCompanyAndBranchData();
        ...
        //List<CHARGETRANSACTION> GetCharge_Details_For_VoucherNo(string VoucherNo, string formcode);
        ...
        List<TNC> getTNCDataForProduct(string tncCode);
        ...
        List<LocationModels> GetRoutineListByPlanCode(string locationId, string planCode, string searchText);
        double GetQuantityUsingPlanNoAndItemLCode(string planCode, string lCode);
        List<RelatedReferenceNoModel> GetRelatedReferenceNoList(string searchText, int formCode);
        ItemLocationDetailUisngVoucherNoModel GetItemLocationDetailUsingIssueNo(string issue_no, int formCode);




        List<DocumentSubMenu> GetMasterTransactionNotSyncList();
        string IsReturnType(string document_no);
        string IsInvoiceType(string document_no);

        IRDLogResponseModel GetIRDLogList(int skip, int take, int page, int pageSize, string fromDate, string toDate, string voucherNo = null);

        //Product Info Hover - Dynamic Data Loading
        ProductInfoDataModel GetProductInfoData(string itemCode, string companyCode, string branchCode, string voucherNo = null, string serialNo = null);

        AccountInfoDataModel GetAccountInfoData(string accCode, string companyCode);
    }
}
