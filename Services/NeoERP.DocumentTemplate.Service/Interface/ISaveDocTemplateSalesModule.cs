...
namespace NeoERP.DocumentTemplate.Service.Interface
{
    public interface ISaveDocTemplateSalesModule
    {
        ...
        ResponseMessage SaveSalesBlanketFormData(SalesBlanketDetailModel salesBlanketDetailModel, CommonFieldForSales commonFieldForSales, NeoErpCoreEntity dbcontext = null);
        ...
        ResponseMessage SaveSalesInvoiceJewelleryFormData(SalesInvoiceJewelleryDetailModel salesInvoiceJewelleryDetailModel,CommonFieldForSales commonFieldForSales, NeoErpCoreEntity dbcontext = null);
        ...
        ResponseMessage SaveSalesReturnJewelleryFormData(SalesReturnJewelleryDetailModel salesReturnJewelleryDetailModel,CommonFieldForSales commonFieldForSales, NeoErpCoreEntity dbcontext = null);
        ...
        ResponseMessage SaveCashVoucherData(dynamic cashVoucherModel, NeoErpCoreEntity dbcontext = null);
        ...
        ResponseMessage UpdateSalesBlanketFormData(SalesBlanketDetailModel salesBlanketDetailModel, CommonFieldForSales commonFieldForSales);
