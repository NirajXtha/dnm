...
namespace NeoERP.DocumentTemplate.Service.Models
{
    public class FormDetails
    {
        ...
        public string PP_NO_VALUE { get; set; }
        ...
        public List<ResourceDetail> RESOURCE_LIST { get; set; }
        public List<ResourceDetail> MANPOWER_RESOURCE_LIST { get; set; }
        public List<ResourceDetail> CONSUMEABLE_POWER_RESOURCE_LIST { get; set; }
    ...
    public class ResourceDetail
    {
        ...
        public List<SerialDetails> SERIALS { get; set; }
    }
    ...
    public class RelatedReferenceNoModel
    {
        public string REFERENCE_NO { get; set; }
        public string VOUCHER_NO { get; set; }
    ...
    public class ItemLocationDetailUisngVoucherNoModel
    {
