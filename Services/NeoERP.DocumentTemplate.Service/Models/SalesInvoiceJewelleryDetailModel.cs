...
{
    public class SalesInvoiceJewelleryDetailModel
    {
        public SalesInvoiceJewelleryDetail MasterInvoiceJewelleryTransaction { get; set; }
        public List<SalesInvoiceJewelleryDetail> ChildInvoiceJewelleryTransaction { get; set; }
