...
{
   public class SalesBlanketDetail
    {
    ...
    public class SalesBlanketMasterTransactionDetails
    {
        public string VOUCHER_NO { get; set; }
    ...
    public class CustomBlanketColumn
    {
    ...
    public class SaveFieldForMasterBlanketTransaction
    {
    ...
    public class SaveFieldForChargeBlanket
    {
    ...
    public class SalesFieldsForSavingFormDataBlanket
    {
