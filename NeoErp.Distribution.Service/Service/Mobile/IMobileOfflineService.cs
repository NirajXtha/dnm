...
namespace NeoErp.Distribution.Service.Service.Mobile
{
    public interface IMobileOfflineService
    {
        ...
        string AddBatteryData(BatteryModel model, NeoErpCoreEntity dbContext);
        string AddDoctorInfo(DoctorModel model, NeoErpCoreEntity dbContext);
        string UpdateVisit(visitUpdate model, NeoErpCoreEntity dbContext);
        string SaveVisitPlan(DoctorVisitPlanList model, NeoErpCoreEntity dbContext);
        string ApproveVisitPlan(approveModel model, NeoErpCoreEntity dbContext);
        string SaveLastConvo(LastConvoData model, NeoErpCoreEntity dbContext);
        Dictionary<string, object> AddDoctorDropdown(NeoErpCoreEntity dbContext);
        Dictionary<string, object> GetWorkingType(NeoErpCoreEntity dbContext);
        Dictionary<string, object> GetDoctorList(string model, NeoErpCoreEntity dbContext);
        GetVisitPlanList GetVisitPlans(string model, NeoErpCoreEntity dbContext);
        GetVisitPlanList GetAllVisitPlans(string model, NeoErpCoreEntity dbContext);
        GetVisitPlanList GetSelfVisitPlans(selfVisit model, NeoErpCoreEntity dbContext);
        Dictionary<string, object> GetUserList(string model, NeoErpCoreEntity dbContext);
        Dictionary<string, object> GetDoctorByArea(AreaModel model, NeoErpCoreEntity dbContext);
        List<LastConvoData> GetLastConvo(string entityCode, string createdBy, NeoErpCoreEntity dbContext);
        List<FarmListModel2> GetFarmList(string spCode, NeoErpCoreEntity dbContext);

        //string AddFarmer(FarmerModel model, NeoErpCoreEntity dbContext);
        string DriverLoginNo(string number, string type, NeoErpCoreEntity dbContext);
        List<DriverModel> GetDriverList(string company_code, NeoErpCoreEntity dbContext);
        List<DriverModel> GetReferenceNo(string number, string company_code, string type, NeoErpCoreEntity dbContext);
        List<AssignedDriverModel> GetAssignedReference(string number, string company_code, string type, NeoErpCoreEntity dbContext);
        string AssignReference(DeliveryAssignModel assign, List<DriverModel> model, NeoErpCoreEntity dbContext);
        List<DeliveryStatus> GetDeliveryStatus(string companyCode, NeoErpCoreEntity dbContext);
        string UpdateDeliveryStatus(DeliveryUpdateModel model, NeoErpCoreEntity dbContext);
        string FarmerUpdateVisit(UpdateVisitFarmer model, NeoErpCoreEntity dbContext);
