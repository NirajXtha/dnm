...
namespace NeoErp.Distribution.Service.Model
{
    ...
    public class DistributorListModel
    {
        ...
        public int? DISTRIBUTOR_SUBTYPE_ID { get; set; }
    ...
    public class ClosingReportModel
    {
        ...
        public string RESELLER_CODE { get; set; }
        public string RESELLER_EDESC { get; set; }
        ...
        public decimal? SECONDARY_SALES { get; set; }
        public decimal? TRANSACTION { get; set; }
        public DateTime? ORDER_DATE { get; set; }
        public DateTime? OPENING_DATE { get; set; }
        public DateTime? CLOSING_DATE { get; set; }
        public int? UPDATE_DAYS { get; set; }
        public List<ClosingReportDetailModel> Details { get; set; } = new List<ClosingReportDetailModel>();
    }
    public class ClosingReportDetailModel
    {
        public string ITEM_CODE { get; set; }
        public string GROUPID { get; set; }
        public string GROUP_EDESC { get; set; }
    ...
    public class FinalDataModel
    {
        ...
        public string TotalBalanceType { get; set; }
        public DateTime? ModifiedDate { get; set; }
    }

    public class ManageAccessModal
    {
