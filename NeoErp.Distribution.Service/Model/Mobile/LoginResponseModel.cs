...
public List<UserAccessModule> USER_ACCESS { get; set; }
        ...
        public string MGR_USER { get; set; }
    ...
    public class PreferenceModel
    {
        ...
        public string ORDER_FROM_TOTAL_QUANTITY { get; set; } = "N";
    ...
    public class UserAccessModule
    {
        ...
        public string ACCESS_FLAG { get; set; }
        public string ICON { get; set; }
        public List<UserAccessMenu> MENU { get; set; }
    }
