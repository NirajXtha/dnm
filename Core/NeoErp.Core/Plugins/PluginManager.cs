...
namespace NeoErp.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private const string ShadowCopyPath = "~/Areas/bin";
        ...
        public static void Initialize()
        {
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    //MVCSettingConfig conf = new MVCSettingConfig();
        ...
        #region Update Plugin code : Handle the pluging in the app - Prem Prakash Dhakal
        //public static void Initialize()
        //{
        //    using (new WriteLockDisposable(Locker))
        //    {
        ...
        //                if (String.IsNullOrWhiteSpace(pluginDescriptor.SystemName))
        //                    throw new Exception($"A plugin '{descriptionFile.FullName}' has no system name. Assign a unique name and recompile.");
        ...
        //                    // 🔒 Load only managed main plugin DLL
        //                    if (mainPluginFile != null && IsManagedAssembly(mainPluginFile.FullName))
        //                    {
        //                        pluginDescriptor.ReferencedAssembly = PerformFileDeploy(mainPluginFile);
        ...
        //                            .Where(x => !x.Name.Equals(mainPluginFile.Name, StringComparison.InvariantCultureIgnoreCase))
        //                            .Where(x => !IsAlreadyLoaded(x))
        //                            .Where(x => IsManagedAssembly(x.FullName)))
        //                        {
        //                            PerformFileDeploy(plugin);
        //                        }
        ...
        //                    else
        //                    {
        //                        Debug.WriteLine($"Skipping unmanaged or missing main plugin: {mainPluginFile?.FullName}");
        //                    }
        //                }
        //                catch (ReflectionTypeLoadException ex)
        //                {
        ...
        //    {
        //        return false; // native/unmanaged DLL
        //    }
        //    catch (FileLoadException)
        //    {
        //        return false; // possibly already loaded or locked
        //    }
        //    catch (Exception)
        //    {
        //        return false; // other unknown issue
        //    }
        //}
        #endregion
        ...
        {
            //var parentDirectory = plug?.Directory?.Parent;
            ...
            ////bikalp test change start
            //else if(CommonHelper.GetTrustLevel() == AspNetHostingPermissionLevel.Unrestricted)
            //{
            //    var shadowCopyPlugFolder = Directory.CreateDirectory(_shadowCopyFolder.FullName);
            //    shadowCopiedPlug = InitializeMediumTrust(plug, shadowCopyPlugFolder);
            //}
            //end bikalp test change
            else
            {
        ...
        private static FileInfo InitializeMediumTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            var shouldCopy = true;
            //var parentDirectory = plug?.Directory?.Parent;
            //FileInfo shadowCopiedPlug = null;
            //if (parentDirectory != null)
            //{
        ...
        private static bool IsPackagePluginFolder(DirectoryInfo folder)
        {
            ...
            //if (!folder.Parent.Name.Equals("Areas", StringComparison.InvariantCultureIgnoreCase)) return false;
            return true;
        }
